<div class="msm-wrap shop-manager">
    <div class="title-bar">
        <h1>Shop List | Multi Store Manager</h1>
        <button class="add-btn button button-primary">Add Store</button>
    </div>
    <form data-title="store" class="store-form form">
                ...
                <tr class="field-group">
                    ...
                    <td>
                        <select name="status" id="status" required>
                            ...
                            <option value="0">Mark as In-active</option>
                        </select>
    ...
    function initAutocomplete() {
        ...
        autocomplete.addListener('place_changed', function() {
            ...
            if (city) {
                ...
                input.value = city; // Get the first part of the city name
